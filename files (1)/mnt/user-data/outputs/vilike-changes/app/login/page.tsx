  ...
  return (
    <div className="flex min-h-[80vh] items-center justify-center px-4">
      <div className="w-full max-w-md rounded-2xl border border-vilike-accent/30 bg-black/60 p-8 shadow-blue-glow">
        ...
        <div className="mt-5 rounded-lg border border-vilike-accent/20 bg-vilike-accent/5 p-4 text-center">
          <p className="text-sm text-vilike-muted">New to VILIKE?</p>
          <p className="mt-0.5 text-xs text-vilike-muted">
            Request portal access and we'll email your passkey once approved.
          </p>
          <Link
            href="/signup"
            className="mt-3 inline-block rounded-lg border border-vilike-accent px-5 py-2 text-sm font-semibold text-vilike-accent hover:bg-vilike-accent hover:text-white transition"
          >
            Request Access →
          </Link>
        </div>
        ...
        <div className="mt-4 rounded-lg bg-white/5 p-3 text-xs text-vilike-muted">
          ...
          <p>Admin: admin@vilikefab.com / demo123</p>
        </div>
      </div>
    </div>
  );
